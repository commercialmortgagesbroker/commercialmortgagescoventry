...
export const metadata: Metadata = {
  title: `${loc} Commercial Mortgage Case Studies | Automotive Industrial, Logistics, HMO, Healthcare, Hospitality`,
  description: `Real ${loc} commercial mortgage case studies, Bayton Road JLR Tier 1 supplier industrial, FarGo Village F&B, Friargate office investment, UHCW Walsgrave dental, Cathedral Quarter boutique hotel, Far Gosford Street semi-commercial, Coventry Gateway B8 logistics, Earlsdon F&B parade, Holbrooks B2-to-mixed-use bridge-to-let and Westwood Business Park office portfolio.`,
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-xl leading-relaxed text-gray-300">
              Representative {loc} and Warwickshire commercial mortgages
              we&apos;ve placed recently across JLR Tier 1 and Tier 2
              automotive supply chain industrial, Coventry Gateway B8
              logistics investment, HMO and semi-commercial portfolio
              refinance, University Hospitals Coventry and Warwickshire
              healthcare ancillary, Cathedral Quarter and FarGo Village
              hospitality, Friargate office investment and Holbrooks
              bridge-to-let. Product type, lender, pricing and the reason
              the file landed where it did.
            </p>
          </div>
        </div>
      </section>
