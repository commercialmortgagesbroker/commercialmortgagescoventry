...
export const faqItems: FAQItem[] = [
  ...
  {
    question: "How long does it take to arrange a Coventry commercial mortgage?",
  ...
  {
    question: "Which Coventry areas do you cover?",
    slug: "which-areas-do-you-cover",
    answer: `We arrange commercial mortgages across the full Coventry metropolitan district and the wider West Midlands footprint. Twelve area pages cover the active commercial sub-markets: City Centre and Cathedral Quarter (CV1 CBD office, retail, heritage hospitality), Friargate (modern Grade A CBD office), Whitley (R and D, JLR engineering catchment), Coventry Gateway, Whitmoor and Ansty (logistics and industrial), Westwood Heath, Tile Hill and Canley (business park and university edge), Earlsdon, Stoneleigh and Cheylesmore (affluent suburban F and B and professional services), Holbrooks, Foleshill and Radford (industrial belt and conversion stock), Wyken, Walsgrave and Hawkesbury (UHCW hospital catchment), Spon End and Coundon (heritage retail and mixed-use), Far Gosford Street and FarGo Village (independent F and B and creative-led regeneration), Allesley and Eastern Green (affluent suburban fringe), Willenhall and Stoke Aldermoor (outer trade and light industrial). Beyond Coventry itself we routinely fund deals in Warwick, Leamington Spa, Kenilworth, Rugby, Nuneaton, Bedworth, Solihull and the wider West Midlands commuter belt from the same Coventry-based lender panel.`,
    relatedLinks: [
