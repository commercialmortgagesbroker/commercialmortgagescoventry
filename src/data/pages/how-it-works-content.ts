/**
 * /how-it-works page content, Commercial Mortgages Coventry.
 *
...
export const howItWorksContent: HowItWorksContent = {
  hero: {
    h1: "How a Coventry commercial mortgage actually completes",
    lede:
      "Five steps from initial enquiry to completion and drawdown. Indicative terms inside two business hours. RICS Red Book valuation in week two or three. Solicitor instruction in parallel. Funds drawn at completion in 4 to 8 weeks for clean owner-occupier and investment deals; 6 to 10 weeks where the sector underwrite needs more work, such as a Bayton Road automotive supply chain industrial owner-occupier, a Friargate office investment refinance, a UHCW Walsgrave dental owner-occupier, a Cathedral Quarter boutique hotel acquisition or a Holbrooks B2-to-mixed-use bridge-to-let.",
  },

  intro: {
    h2: "Commercial mortgage in one paragraph",
    body: [
      'A commercial mortgage is <strong>long-term debt secured against income-producing or owner-occupied commercial property</strong>. In the Coventry market for mid-2026, facilities are typically structured at 65 to 75 percent LTV across 5 to 25 year terms, with monthly capital and interest payments. Rates run 6.0 to 9.0 percent pa depending on product, sector, LTV and covenant strength. Arrangement fees usually 1 to 2 percent of the facility, RICS Red Book valuation 1,500 to 8,000 pounds depending on asset complexity (Cathedral Quarter boutique hotel acquisition, Friargate Grade A office investment and any listed-building work in the Cathedral Quarter conservation area sit at the top of that band), and legal fees both sides.',
    ...
    items: [
      {
        ...
        detail:
          "Two years of clean filed accounts is the typical minimum. Specialists flex to 12 to 18 months in defensive regulated sectors, dental, GP, pharmacy, established trades, particularly across the UHCW Walsgrave healthcare ancillary catchment and the JLR Tier 1 and Tier 2 supplier ecosystem.",
      },
      {
      ...
      },
      {
        ...
        detail:
          "Gross rent against interest cost at 140 to 160 percent stressed at a notional rate 1 to 2 percent above the pay rate. Strong tenant covenant on a long lease prices best, JLR Tier 1 covenants on the Bayton Road and Holbrook Lane industrial belt and Coventry Gateway B8 logistics covenants underwrite particularly cleanly.",
      },
      {
        label: "Deposit",
        detail:
      ...
      },
      {
        ...
        detail:
          "CQC rating Good or above for care, Ofsted Good or above for nursery, NHS contract for dental, occupancy and ADR for hotel, barrelage and EBITDA for pub. The UHCW Walsgrave catchment generates clean evidence packs on the healthcare ancillary side; the Cathedral Quarter generates clean evidence packs on the boutique-hotel side.",
      },
      {
  ...
  timeline: {
    h2: "How long does a Coventry commercial mortgage take?",
    body:
      'From a clean enquiry through to completion and drawdown: <strong>4 to 8 weeks</strong> for mainstream owner-occupier, commercial investment and semi-commercial. <strong>6 to 10 weeks</strong> for trading-business cases (Cathedral Quarter boutique hotel, Earlsdon F and B, UHCW Walsgrave care home) and HMO portfolio refinance involving multi-property redemption sequencing across CV1, CV4, CV5 and CV6. The critical-path item is almost always the RICS Red Book valuation. The fastest clean owner-occupier completion on our recent record was <strong>28 working days</strong>, a Westwood Business Park professional office acquisition where the borrower had two years of clean accounts ready, the solicitor moved quickly on enquiries, and the lender had recent comparable approvals on file at the same Midlands valuer.',
  },
};
