/**
 * /services hub page content, Commercial Mortgages Coventry.
 *
 ...
 * NeuronWriter target ~652 words for the `commercial mortgage broker coventry`
...
export const servicesContent: ServicesContent = {
  hero: {
    h1: "Commercial Mortgage Broker Coventry, 90+ Lenders",
    lede:
  ...
  mapIntro: {
    h2: "Where the deals are placed across Coventry and the West Midlands",
    body:
      'From the <a href="/areas/city-centre-cathedral-quarter" class="text-secondary font-medium hover:underline">CV1 CBD</a> office and heritage hospitality market through the <a href="/areas/friargate" class="text-secondary font-medium hover:underline">Friargate</a> Grade A office quarter, the <a href="/areas/earlsdon-stoneleigh-cheylesmore" class="text-secondary font-medium hover:underline">Earlsdon</a> and <a href="/areas/far-gosford-street-fargo-village" class="text-secondary font-medium hover:underline">Far Gosford Street</a> semi-commercial spines, the <a href="/areas/allesley-eastern-green" class="text-secondary font-medium hover:underline">Allesley and Eastern Green</a> care-home cluster, and the <a href="/areas/coventry-gateway-whitmoor-ansty" class="text-secondary font-medium hover:underline">Coventry Gateway, Whitmoor and Ansty</a> logistics corridor. Use the map below to see live placement activity across the City of Coventry.',
  },
  ...
  services: [
    {
      ...
      paragraphs: [
        "When the business buys the building it trades from, the lending test is <strong>EBITDA cover</strong>, trading profit measured against the monthly mortgage payment, with a typical comfort threshold of 1.3–1.5×. This is the dental partnership taking the UHCW Walsgrave surgery freehold off a retiring principal; the accountancy firm converting a Friargate lease into a floor purchase; the engineering business buying its Coventry Gateway trade-counter unit off the landlord. Two years of clean filed accounts is the standard minimum. LTV runs to <strong>75%</strong>, deposits of 25–30% are typically funded from accumulated retained profit (and occasionally capital-released equity from a director's home).",
        'Allica Bank, <strong>Shawbrook</strong>, Hampshire Trust Bank, Cambridge & Counties and <strong>Cynergy Bank</strong> sit at the sweet spot for owner-occupier lending. <strong>Lloyds</strong> commercial banking, <strong>NatWest</strong> commercial, <strong>Barclays</strong> and <strong>Santander</strong> price competitively where the covenant is strong and the sector is mainstream. Mid-2026 interest rates: <strong>6.0–7.5% pa</strong>. Term length is the lever that materially changes affordability, extending repayment from 15 to 20 years frequently clears the EBITDA test where rate alone will not. Owner-occupier sits outside FCA regulation in most cases (it is a business borrowing for business premises, not a residential mortgage).',
        'Sectors with the deepest lender appetite in Coventry: dental and GP practices (the UHCW Walsgrave catchment is a recognised sub-market), accountancy, legal and other professional services, light industrial and trade-counter (Coventry Gateway, Ansty Park, Holbrooks) and pharmacy. Sector-specialist trades, care home, MOT, day nursery, route through <a href="/services/trading-business-mortgage" class="text-secondary font-medium hover:underline">trading-business mortgages</a> instead.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Tenant covenant and lease length carry as much weight as LTV. A 10-year unbroken FRI lease to a national covenant on a Friargate office prices materially better than three two-year leases to local independents on a secondary parade. <strong>NatWest</strong>, <strong>Lloyds</strong>, <strong>Barclays</strong> and <strong>Santander</strong> compete hard on prime single-asset investment; <strong>Shawbrook</strong>, <strong>InterBay Commercial</strong>, <strong>LendInvest</strong> and Together cover the trickier end (multi-let, short-WAULT, semi-commercial, vacant-with-refurb). Interest rates currently <strong>6.5–8.5% pa</strong>.',
        'Active areas: <a href="/areas/city-centre-cathedral-quarter" class="text-secondary font-medium hover:underline">city-centre office and retail</a>, <a href="/areas/earlsdon-stoneleigh-cheylesmore" class="text-secondary font-medium hover:underline">Earlsdon</a> semi-commercial parades, <a href="/areas/far-gosford-street-fargo-village" class="text-secondary font-medium hover:underline">Far Gosford Street and FarGo Village</a> creative-led regeneration, and the Coventry Gateway logistics corridor.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        'Semi-commercial finance funds mixed-use property where the residential element is at least 40% of total floorspace, the classic shop-with-flat-above archetype that defines Coventry high streets like <a href="/areas/earlsdon-stoneleigh-cheylesmore" class="text-secondary font-medium hover:underline">Earlsdon High Street</a> in CV5, Far Gosford Street in the <a href="/areas/far-gosford-street-fargo-village" class="text-secondary font-medium hover:underline">FarGo Village</a> quarter, Coundon Road in <a href="/areas/spon-end-coundon" class="text-secondary font-medium hover:underline">Coundon</a> and Walsgrave Road through <a href="/areas/wyken-walsgrave-hawkesbury" class="text-secondary font-medium hover:underline">Wyken</a>. The flat above gives lenders residential security comfort, so semi-commercial routinely prices 50–100bps inside pure commercial investment.',
        '<strong>InterBay Commercial</strong> (part of OSB Group) and <strong>Shawbrook</strong> are the two most active named desks; <strong>LendInvest</strong>, Together, Aldermore, YBS Commercial and Hampshire Trust Bank also quote actively. The lending test combines commercial rent and residential AST income on a blended basis, with cover typically required at <strong>~145%</strong>. LTV to 75% is achievable on standard archetypes. Where the borrower will personally occupy one of the flats, the deal can fall under FCA-regulated mortgage rules, we flag that at outset and route to a regulated lender if it applies.',
        'Common Coventry archetypes: shop with one to three flats over (Earlsdon, Coundon, Far Gosford Street, Kenilworth), pub or restaurant with operator flat above, and mixed-use conversions where consent is for ground-floor retail plus four to six apartments on upper floors. For HMO conversions see our <a href="/property-types/hmo-block" class="text-secondary font-medium hover:underline">HMO block</a> page.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '<strong>Shawbrook</strong>, Cambridge & Counties, <strong>InterBay Commercial</strong> and <strong>Cynergy Bank</strong> are the most active portfolio lenders for the £2M–£15M Coventry bracket. OakNorth and Reliance Bank cover larger facility sizes. Aggregate ICR is tested across the portfolio at <strong>140–150%</strong>; tenant concentration matters (more than 20–25% of income from one tenant tightens pricing); sector concentration matters; West Midlands geographic concentration is fine.',
    ...
    },
    {
      ...
      paragraphs: [
        'Trading-business mortgages fund operational property where value is bound up with the business that runs from it. Pubs on Spon Street, Earlsdon High Street and the Kenilworth market spine; hotels in the Cathedral Quarter and around Friargate; care homes in <a href="/areas/allesley-eastern-green" class="text-secondary font-medium hover:underline">Allesley and Eastern Green</a>, Cheylesmore and Coundon; MOT and petrol forecourts in Holbrooks, Foleshill and outer Coventry; day nurseries in Earlsdon, Stoke and Allesley; dental practices across the UHCW Walsgrave catchment; B&Bs around Kenilworth and Leamington.',
        'Underwriting is sector-specific. <strong>Pubs</strong>: barrelage, EBITDA, beer-tie status, license, <strong>Cynergy Bank</strong> and ASK Partners dominate. <strong>Hotels</strong>: occupancy, ADR, RevPAR. <strong>Care homes</strong>: CQC rating, occupancy, weighted-average bed value, council/private fee mix, <strong>Shawbrook</strong>, Cambridge & Counties and Hampshire Trust hold significant West Midlands books. <strong>Dental</strong>: NHS UDA value plus private fee mix. <strong>MOT</strong>: VOSA approval, environmental due diligence. <strong>Nursery</strong>: Ofsted rating, registered places, occupancy.',
    ...
    },
    {
      ...
      paragraphs: [
        'Commercial remortgage covers two distinct moments. End of a typical 5-year fix maturing into a different rate environment; or capital-raise refinancing that releases equity from a property that has appreciated since the original draw. With Bank of England base-rate trajectory through 2026 looking flatter than the 2023–24 cycle, refinancing demand into Coventry is strong, particularly on assets bought 2019–2021 where current valuations support a meaningfully better LTV than the original facility.',
        ...
        'For end-of-fix the underwriting story is usually clean, known asset, known borrower, known track record. <strong>NatWest</strong>, <strong>Lloyds</strong>, <strong>Barclays</strong>, <strong>Santander</strong>, <strong>Shawbrook</strong>, Allica, Hampshire Trust Bank, Cambridge & Counties and <strong>InterBay Commercial</strong> all compete on clean Coventry remortgage business. Pricing for owner-occupier remortgage at 65% LTV on a strong covenant: <strong>6.0–7.5% pa</strong>. Investment remortgage 6.5–8.5% pa.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '<strong>LendInvest</strong>, <strong>Shawbrook</strong>, Together, OakNorth and Hampshire Trust Bank are the most active commercial bridging desks for the Coventry £500K–£5M bracket. Bridge interest rates currently run <strong>0.70–0.95% pm</strong> (8.5–11.5% pa equivalent); term-out pricing back to mainstream <strong>6.5–8.5% pa</strong> once the property stabilises and the ICR test passes. Interest can be serviced monthly or rolled-up; LTVs to 70% on current value, sometimes 75% on day-one purchase price plus 100% of refurb costs against GDV.',
        'Where this works particularly well in Coventry: vacant CV1 office floorplates being refurbished for re-letting; semi-commercial conversions (shop+flat-above stock being upgraded); industrial units bought from receivers; trading businesses bought as going concerns where the new operator needs 12 months of accounts before a high-street remortgage will engage.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '<strong>InterBay Commercial</strong>, Together, United Trust Bank and select private-credit desks are the active second-charge commercial lenders for Coventry. Pricing reflects subordinated risk: <strong>10–14% pa</strong> typically, arrangement fees of 2–3%. Combined LTV (first plus second) usually capped at <strong>70–75%</strong>, occasionally flexed to 80% on strong investment cases.',
  ...
  networkBand: {
    ...
    paragraphs: [
      ...
      "Owner-occupier in Manchester, portfolio refinancing across the West Midlands and the East Midlands, a trading-business mortgage in Newcastle, or a commercial remortgage on a Bristol office, the same panel, the same diagnostic process, the same unregulated commercial product set.",
    ],
  },

  finalCta: {
    h2: "Which product fits your Coventry deal?",
    body:
