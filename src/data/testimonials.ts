/**
 * Testimonials, Commercial Mortgages Coventry.
 *
...
export const testimonials: Testimonial[] = [
  {
    quote:
      "Quoted 8.95% pa over 15 years on the CV3 surgery freehold by my own commercial bank. Matt benchmarked four dental-active lenders, came back at 6.85% over 20 years, and completed inside the vendor's 60-day window. The longer term was the unlock, EBITDA cover went from a tight 1.28x to a comfortable 1.51x. No surprises at credit committee.",
    author: "Dr A. Patel",
    role: "Dental practice principal",
    location: "Cheylesmore, Coventry (CV3)",
  },
  {
    quote:
  ...
  },
  {
    ...
    location: "Whitley, Coventry (CV3)",
  },
  {
    quote:
      "First semi-commercial purchase, Earlsdon High Street shop with three flats above. Matt screened the FCA regulated mortgage perimeter on the first call to confirm the unregulated route was clean (residential floor area was 38%), then placed it with InterBay Commercial at 75% LTV, 7.25% pa over 25 years. Blended ICR at 142%. Approval in nine working days.",
    author: "T. Wells",
